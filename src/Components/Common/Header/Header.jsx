...
const Header = ({headerLogo}) => {
    ...
    const {headerContainer, headerLogoStyle,headerTitle,borrowNowButton} = styles;
    return ( 
    <header className={headerContainer}>
       <NavBar /> 
       <h2 className={headerTitle}>THE BEST SITE FOR <br /> BORROWING BOOKS</h2>
       <div className={borrowNowButton}><Button label='Borrow Now'/></div>
